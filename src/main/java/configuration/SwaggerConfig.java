package configuration;
	...
	.title("API - Blog Pessoal Fernanda")
	.description("Projeto API Spring - Blog Pessoal")
	.version("1.0.0")
	.license("Apache License Version 2.0")
	.licenseUrl("https://github.com/Fernanda2207")
	.contact(contact())
	.build();
	}
	private static Contact contact() {
	return new Contact("Fernanda Silva",
	"https://github.com/Fernanda2207",
	"lefeee1422@gmail.com");
	}
